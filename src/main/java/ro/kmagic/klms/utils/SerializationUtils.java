...
public interface SerializationUtils {
    default String itemStackArrayToBase64(ItemStack[] items) throws IllegalStateException {
        try {
    ...
    default ItemStack[] itemStackArrayFromBase64(String data) throws IOException {
        try {
